...
var EthLightwalletSubprovider = /** @class */ (function (_super) {
    ...
    EthLightwalletSubprovider.prototype.signTransactionAsync = function (txParams) {
        return __awaiter(this, void 0, void 0, function () {
            var privKey, privKeyWallet, privKeySignature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        privKey = this._keystore.exportPrivateKey(txParams.from, this._pwDerivedKey);
                        privKeyWallet = new private_key_wallet_1.PrivateKeyWalletSubprovider(privKey);
                        privKey = '';
                        return [4 /*yield*/, privKeyWallet.signTransactionAsync(txParams)];
                    case 1:
                        privKeySignature = _a.sent();
                        return [2 /*return*/, privKeySignature];
                }
            });
        });
    };
    ...
    EthLightwalletSubprovider.prototype.signPersonalMessageAsync = function (data, address) {
        return __awaiter(this, void 0, void 0, function () {
            var privKey, privKeyWallet, result;
            return __generator(this, function (_a) {
                privKey = this._keystore.exportPrivateKey(address, this._pwDerivedKey);
                privKeyWallet = new private_key_wallet_1.PrivateKeyWalletSubprovider(privKey);
                privKey = '';
                result = privKeyWallet.signPersonalMessageAsync(data, address);
