...
var erc20_token_1 = require("./generated/erc20_token");
...
var ERC20TokenWrapper = /** @class */ (function (_super) {
    ...
    function ERC20TokenWrapper(web3Wrapper, networkId, erc20ProxyWrapper, blockPollingIntervalMs) {
        ...
        _this.abi = artifacts_1.artifacts.ERC20Token.compilerOutput.abi;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tokenContract = _a.sent();
                        return [4 /*yield*/, tokenContract.approve.sendTransactionAsync(normalizedSpenderAddress, amountInBaseUnits, removeUndefinedProperties({
    ...
    ERC20TokenWrapper.prototype.getProxyAllowanceAsync = function (tokenAddress, ownerAddress, methodOpts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        proxyAddress = this._erc20ProxyWrapper.getContractAddress();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, tokenContract.transfer.sendTransactionAsync(normalizedToAddress, amountInBaseUnits, removeUndefinedProperties({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, tokenContract.transferFrom.sendTransactionAsync(normalizedFromAddress, normalizedToAddress, amountInBaseUnits, removeUndefinedProperties({
    ...
    ERC20TokenWrapper.prototype.subscribe = function (tokenAddress, eventName, indexFilterValues, callback, isVerbose) {
        ...
        assert_1.assert.isETHAddressHex('tokenAddress', tokenAddress);
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, erc20_token_1.ERC20TokenEvents);
        ...
        var subscriptionToken = this._subscribe(normalizedTokenAddress, eventName, indexFilterValues, artifacts_1.artifacts.ERC20Token.compilerOutput.abi, callback, isVerbose);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        normalizedTokenAddress = tokenAddress.toLowerCase();
                        return [4 /*yield*/, this._getLogsAsync(normalizedTokenAddress, eventName, blockRange, indexFilterValues, artifacts_1.artifacts.ERC20Token.compilerOutput.abi)];
                    case 1:
                        logs = _a.sent();
    ...
    ERC20TokenWrapper.prototype._invalidateContractInstances = function () {
        this.unsubscribeAll();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getContractAbiAndAddressFromArtifactsAsync(artifacts_1.artifacts.ERC20Token, normalizedTokenAddress)];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 2]), abi = _a[0], address = _a[1];
                        contractInstance = new erc20_token_1.ERC20TokenContract(abi, address, this._web3Wrapper.getProvider(), this._web3Wrapper.getContractDefaults());
