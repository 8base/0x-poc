...
import { ERC20TokenEventArgs, ERC20TokenEvents } from './generated/erc20_token';
/**
 * This class includes all the functionality related to interacting with ERC20 token contracts.
 * All ERC20 method calls are supported, along with some convenience methods for getting/setting allowances
 * to the 0x ERC20 Proxy smart contract.
 */
export declare class ERC20TokenWrapper extends ContractWrapper {
    abi: ContractAbi;
    UNLIMITED_ALLOWANCE_IN_BASE_UNITS: BigNumber;
    private _tokenContractsByAddress;
    private _erc20ProxyWrapper;
    /**
     ...
     */
    constructor(web3Wrapper: Web3Wrapper, networkId: number, erc20ProxyWrapper: ERC20ProxyWrapper, blockPollingIntervalMs?: number);
    /**
     ...
     */
    subscribe<ArgsType extends ERC20TokenEventArgs>(tokenAddress: string, eventName: ERC20TokenEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends ERC20TokenEventArgs>(tokenAddress: string, eventName: ERC20TokenEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    private _invalidateContractInstances;
    private _getTokenContractAsync;
}
//# sourceMappingURL=erc20_token_wrapper.d.ts.map