...
import { ExchangeEventArgs, ExchangeEvents } from './generated/exchange';
/**
...
export declare class ExchangeWrapper extends ContractWrapper {
    ...
    private _erc721TokenWrapper;
    private _erc20TokenWrapper;
     ...
     */
    constructor(web3Wrapper: Web3Wrapper, networkId: number, erc20TokenWrapper: ERC20TokenWrapper, erc721TokenWrapper: ERC721TokenWrapper, contractAddressIfExists?: string, zrxContractAddressIfExists?: string, blockPollingIntervalMs?: number);
    /**
