...
var OrderValidatorContract = /** @class */ (function (_super) {
    ...
    function OrderValidatorContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'OrderValidator', abi, address, provider, txDefaults) || this;
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [order,
                                    takerAddress
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), order = _a[0], takerAddress = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [order,
                                    takerAddress
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getOrderAndTraderInfo;
                            ...
                            case 2:
                                ...
                                outputAbi = _.find(self.abi, { name: 'getOrderAndTraderInfo' }).outputs;
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [target,
                                    assetData
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), target = _a[0], assetData = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [target,
                                    assetData
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getBalanceAndAllowance;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getBalanceAndAllowance' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'getOrdersAndTradersInfo(tuple[],address[])';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orders,
                                    takerAddresses
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), orders = _a[0], takerAddresses = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [orders,
                                    takerAddresses
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getOrdersAndTradersInfo;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getOrdersAndTradersInfo' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'getTradersInfo(tuple[],address[])';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [orders,
                                    takerAddresses
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), orders = _a[0], takerAddresses = _a[1];
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getTradersInfo;
                                encodedData = ethersFunction.encode([orders,
                                    takerAddresses
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getTradersInfo' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [token,
                                    tokenId
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), token = _a[0], tokenId = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [token,
                                    tokenId
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getERC721TokenOwner;
                                encodedData = ethersFunction.encode([token,
                                    tokenId
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getERC721TokenOwner' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getBalancesAndAllowances;
                                encodedData = ethersFunction.encode([target,
                                    assetData
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getBalancesAndAllowances' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getTraderInfo;
                                encodedData = ethersFunction.encode([order,
                                    takerAddress
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getTraderInfo' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
    ...
    OrderValidatorContract.deployFrom0xArtifactAsync = function (artifact, provider, txDefaults, _exchange, _zrxAssetData) {
        return __awaiter(this, void 0, void 0, function () {
            var bytecode, abi;
    ...
    OrderValidatorContract.deployAsync = function (bytecode, abi, provider, txDefaults, _exchange, _zrxAssetData) {
        return __awaiter(this, void 0, void 0, function () {
