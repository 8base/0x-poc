...
var CONTRACT_NAME_TO_NOT_FOUND_ERROR = {
    ZRX: types_1.ContractWrappersError.ZRXContractDoesNotExist,
    EtherToken: types_1.ContractWrappersError.EtherTokenContractDoesNotExist,
    ERC20Token: types_1.ContractWrappersError.ERC20TokenContractDoesNotExist,
    ERC20Proxy: types_1.ContractWrappersError.ERC20ProxyContractDoesNotExist,
    ERC721Token: types_1.ContractWrappersError.ERC721TokenContractDoesNotExist,
    ERC721Proxy: types_1.ContractWrappersError.ERC721ProxyContractDoesNotExist,
    Exchange: types_1.ContractWrappersError.ExchangeContractDoesNotExist,
};
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (_.isUndefined(addressIfExists)) {
                            if (_.isUndefined(artifact.networks[this._networkId])) {
                                throw new Error(types_1.ContractWrappersError.ContractNotDeployedOnNetwork);
                            }
                    ...
                    case 1:
                        ...
                        abiAndAddress = [artifact.compilerOutput.abi, contractAddress];
