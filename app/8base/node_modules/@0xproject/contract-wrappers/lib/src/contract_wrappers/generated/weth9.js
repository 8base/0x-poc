    ...
    function WETH9Contract(abi, address, provider, txDefaults) {
        ...
        _this.approve = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [guy,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), guy = _a[0], wad = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [guy,
                                    wad
                                ]);
                                encodedData = self._lookupEthersInterface('approve(address,uint256)').functions.approve.encode([guy,
                                    wad
                                ]);
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [guy,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString), 2), guy = _a[0], wad = _a[1];
                                encodedData = self._lookupEthersInterface('approve(address,uint256)').functions.approve.encode([guy,
                                    wad
                                ]);
            ...
            getABIEncodedTransactionData: function (guy, wad) {
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('approve(address,uint256)').functions.approve.encode([guy,
                    wad
                ]);
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                encodedData = ethersFunction.encode([guy,
                                    wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [src,
                                    dst,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 3), src = _a[0], dst = _a[1], wad = _a[2];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [src,
                                    dst,
                                    wad
                                ]);
                                encodedData = self._lookupEthersInterface('transferFrom(address,address,uint256)').functions.transferFrom.encode([src,
                                    dst,
                                    wad
                                ]);
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [src,
                                    dst,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString), 3), src = _a[0], dst = _a[1], wad = _a[2];
                                encodedData = self._lookupEthersInterface('transferFrom(address,address,uint256)').functions.transferFrom.encode([src,
                                    dst,
                                    wad
                                ]);
            ...
            getABIEncodedTransactionData: function (src, dst, wad) {
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('transferFrom(address,address,uint256)').functions.transferFrom.encode([src,
                    dst,
                    wad
                ]);
                return abiEncodedTransactionData;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                encodedData = ethersFunction.encode([src,
                                    dst,
                                    wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
        ...
        _this.withdraw = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [wad
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 1), wad = _a[0];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [wad
                                ]);
                                encodedData = self._lookupEthersInterface('withdraw(uint256)').functions.withdraw.encode([wad
                                ]);
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi('withdraw(uint256)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [wad
                                ], base_contract_1.BaseContract._bigNumberToString), 1), wad = _a[0];
                                encodedData = self._lookupEthersInterface('withdraw(uint256)').functions.withdraw.encode([wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
            ...
            getABIEncodedTransactionData: function (wad) {
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('withdraw(uint256)').functions.withdraw.encode([wad
                ]);
                return abiEncodedTransactionData;
            },
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.withdraw;
                                encodedData = ethersFunction.encode([wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'withdraw' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
        ...
        _this.transfer = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [dst,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), dst = _a[0], wad = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [dst,
                                    wad
                                ]);
                                encodedData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer.encode([dst,
                                    wad
                                ]);
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [dst,
                                    wad
                                ], base_contract_1.BaseContract._bigNumberToString), 2), dst = _a[0], wad = _a[1];
                                encodedData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer.encode([dst,
                                    wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
            ...
            getABIEncodedTransactionData: function (dst, wad) {
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('transfer(address,uint256)').functions.transfer.encode([dst,
                    wad
                ]);
                return abiEncodedTransactionData;
            },
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                encodedData = ethersFunction.encode([dst,
                                    wad
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
        ...
        _this.deposit = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, []);
                                encodedData = self._lookupEthersInterface('deposit()').functions.deposit.encode([]);
            ...
            getABIEncodedTransactionData: function () {
                ...
                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString);
                var abiEncodedTransactionData = self._lookupEthersInterface('deposit()').functions.deposit.encode([]);
                return abiEncodedTransactionData;
            },
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, []);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.deposit;
                                encodedData = ethersFunction.encode([]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'deposit' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
